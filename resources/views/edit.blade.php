...
<nav class="navbar navbar-light bg-light">
  <div class="container">
    <div class="h4 mt-4 mb-3 ml-4">Edit Data</div>
  </div>
</nav>
<div class="container mt-4 mb-4">
    <div class="row">
        ...
        <div class="form-group">
            <label>Nik</label>
            <input type="text" class="form-control @error('nik') is-invalid @enderror" value="{{ $data->nik }}"  id="nik" name="nik" >
            @error('nik')
        ...
        <div class="form-group">
            ...
            <input type="text" name="lahir" id="picker" class="form-control" placeholder="Lahir" value="{{ $data->lahir }}">
        ...
        <div class="form-group">
                ...
                <input type="text" class="form-control @error('penghasilan') is-invalid @enderror" value="{{ $data->penghasilan  }}" id="penghasilan" name="penghasilan">
                @error('penghasilan')
                <div class="invalid-feedback">
                {{ $message }}
                </div>
        ...
        <div class="form-group">
                <label>Job</label>
                <input type="text" class="form-control @error('job') is-invalid @enderror" value="{{  $data->job }}" id="job" name="job">
                @error('job')
                <div class="invalid-feedback">
                {{ $message }}
                </div>
